...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    CCILogViewController *lvc = [[CCILogViewController alloc] init];
    UINavigationController *logNavController = [[UINavigationController alloc] initWithRootViewController:lvc];
    logNavController.tabBarItem.title = @"Log";
    UIImage *logImage = [UIImage imageNamed:@"Placeholder.png"];
    logNavController.tabBarItem.image = logImage;
    
    CCIStatsViewController *svc = [[CCIStatsViewController alloc] init];
    UINavigationController *statsNavController = [[UINavigationController alloc] initWithRootViewController:svc];
    statsNavController.tabBarItem.title = @"Stats";
    UIImage *statsImage = [UIImage imageNamed:@"Placeholder.png"];
    statsNavController.tabBarItem.image = statsImage;
    
    UITabBarController *tabBarController = [[UITabBarController alloc] init];
    tabBarController.viewControllers = @[logNavController, statsNavController];
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    NSLog(@"applicationDidEnterBackground started");
    ...
    NSLog(@"applicationDidEnterBackground finished");
